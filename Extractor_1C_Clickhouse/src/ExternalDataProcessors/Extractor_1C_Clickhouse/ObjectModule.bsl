...
Функция СведенияОВнешнейОбработке() Экспорт 
	...
	РегистрационныеДанные.Вставить("Версия", "1.2.7");
...
Функция ВыполнитьКомандуСервер(ИдентификаторКоманды) Экспорт
	...
	Если МассивПодстроки[1] = "ClickHouseНаСервере" Тогда  
		...
		ВыгрузитьДанныеВБазуДанныхНаСервере(ПараметрыОбработки, МассивПодстроки);
	КонецЕсли;
...
//<<%%>> ilya@kimkarus.ru @kimkarus kimkarus.ru # Ilya Kosarev 27-10-2023 9:30 start 
Процедура ВыгрузитьДанныеВБазуДанныхНаСервере(Параметры, МассивПодстроки = Неопределено) Экспорт
