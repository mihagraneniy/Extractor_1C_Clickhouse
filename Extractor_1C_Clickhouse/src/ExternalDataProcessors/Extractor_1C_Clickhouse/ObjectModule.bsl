...
Функция СведенияОВнешнейОбработке() Экспорт 
	...
	РегистрационныеДанные.Вставить("Версия", "1.2.8");
	...
	Для Счетчик = 1 По КоличествоНастроек + 1 Цикл
...
Процедура ВыгрузитьДанныеВБазуДанныхНаСервере(Параметры, ТипКоманды = "") Экспорт
	...
	//Если ТипКоманды = "ФоноваяПоУмолчанию" Тогда
...
//<<%%>> ilya@kimkarus.ru @kimkarus kimkarus.ru # Ilya Kosarev 17-05-2025 9:30 start
Функция ПолучитьМассивДополнительныхКлючей()
	МассивМ = Новый Массив;
	//
